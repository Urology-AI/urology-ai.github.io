...
<figure class="walk-step">
  <img src="{{ "/assets/img/projects/compass/01-demographics.jpg" | relative_url }}" alt="Demographics and labs" loading="lazy">
...
<figure class="walk-step">
  <img src="{{ "/assets/img/projects/compass/02-zone-map.jpg" | relative_url }}" alt="Zone map" loading="lazy">
...
<figure class="walk-step">
  <img src="{{ "/assets/img/projects/compass/03-predictions.jpg" | relative_url }}" alt="Surgical plan and 3D prostate" loading="lazy">
...
<figure class="walk-step">
  <img src="{{ "/assets/img/projects/compass/04-zone-risk.jpg" | relative_url }}" alt="Risk by zone" loading="lazy">
  <figcaption><strong>Risk by zone.</strong> The 3D model coloured by extracapsular-extension risk in each zone.</figcaption>
</figure>
<figure class="walk-step">
  <img src="{{ "/assets/img/projects/compass/05-nerve-sparing-plan.jpg" | relative_url }}" alt="Nerve-sparing plan" loading="lazy">
  <figcaption><strong>Nerve-sparing plan.</strong> The planned approach on each side, shown on the model.</figcaption>
</figure>
<figure class="walk-step">
  <img src="{{ "/assets/img/projects/compass/06-functional-outcomes.jpg" | relative_url }}" alt="Functional outcomes" loading="lazy">
